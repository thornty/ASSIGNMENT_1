...
final_data <- full_data %>%
  left_join(first_visits_data, by = "SUBJ")
```
...
```{r revert_encoding}
final_data$Gender[final_data$Gender == 2] <- "female"
final_data$Gender[final_data$Gender == 1] <- "male"

final_data$Diagnosis[final_data$Diagnosis == 'A'] <- "ASD"
final_data$Diagnosis[final_data$Diagnosis == 'B'] <- "TD"
```
