...
part_merge <- merge(demo_train, token_train, by.x=c("SUBJ","VISIT"), by.y=c("SUBJ","VISIT"))
full_merge <- merge(part_merge, LU_train, by.x=c("SUBJ", "VISIT"), by.y=c("SUBJ", "VISIT"))
...
data2.0 <- merge(full_merge, data_VISIT1, by.x 'SUBJ', by.y ='SUBJ')
...
write.csv(data3.0, "ASD_lang.csv")
```
